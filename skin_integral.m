function result = skin_integral(image)
%%
...
% image = imread('training_test_data/test_face_photos/clintonAD2505_468x448.jpg');
figure; imshow(image, []);

% Apply skin detection
skin_detection = detect_skin(image, positive_histogram,  negative_histogram);
skin_threshold = 0.5; % threshold to binarize skin detection image
